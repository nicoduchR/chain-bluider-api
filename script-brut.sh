...
geth account import --datadir ./datadir /root/key1.txt
...
echo "[program:node]
command=geth --datadir /root/datadir/ --syncmode 'full' --port 30311 --rpc --rpcaddr '0.0.0.0' --rpcport 8501 --rpcapi 'personal,db,eth,net,web3,txpool,miner,admin,clique' --bootnodes '$enode' --networkid 1101 -unlock '$address' --password /root/datadir/password.txt --mine --allow-insecure-unlock
autostart=true
autorestart=true
